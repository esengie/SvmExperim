...
plot(1-woTestNumS, woTestNumR, type="l",lwd=4, col = "blue", xlab = "1 - Specificity", ylab = "Sensitivity", cex.axis = cx, cex.lab = cx, ylim=c(0.8,1), xlim=c(0,0.2))
lines(1-withTestNumS, withTestNumR, col = "red", lwd=4, ylim=c(0.8,1), xlim=c(0,0.2))
